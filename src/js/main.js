...
// Función para calcular los niveles de descuento
...
// Función para actualizar la tabla de totales
...
// Función para actualizar el total general de la tabla
...
// Función para analizar la expresión de la calculadora y eliminar *1
...
// Función para actualizar la tabla con los valores más recientes
...
// Función para manejar la validación de números y actualizaciones de la tabla
...
// Función para manejar el teclado virtual de la calculadora
function handleCalcKeyClick(event) {
...
// Manejo de la selección de niveles
...
function handleCalculatorInputBlur(event) {
    let equation = $(this).val();
...
$(document).ready(function () {
    ...
    // Asociar los eventos a los elementos correspondientes
    $('#calculatorInput').on('input', handleCalculatorInputChange);
    $('#calculatorInput').on('blur', handleCalculatorInputBlur);
    $(document).on('blur', '.editable', handleEditableCellBlur);
    $('#exportCsv').on('click', exportCsv);
    $(document).on('click', '.calc-key', handleCalcKeyClick);
    $('#levelSelect').on('change', handleLevelSelectChange);
});
